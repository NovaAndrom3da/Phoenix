...
https://github.com/ThatOneCalculator/BASED-LICENSE/issues
or send me an email at <kainoa@t1c.dev>.

A non-legally binding summary of the license can be found here:
https://github.com/ThatOneCalculator/BASED-LICENSE/blob/main/SUMMARY.md

---

While the software author(s) can modify the Based License, any and all revisions must be stated below,
including how it was modified.

Have the license terms been modified? If so, how was it modified?
The BASED-CS-DL version of the BASED license allow the users to use the software inside of a closed source
program or program collection. It also allows for different licensing for dependencies and other software that
requires this.
...
All references of "license", "the license", or "Based License" refer to the software license located at
https://github.com/ThatOneCalculator/BASED-LICENSE/blob/main/LICENSE. References to "the software" refer to the
program(s) in which this license is used. "The author(s)" and "the contributor(s)" refer to the author(s)
and contributor(s) of the software using the license, unless otherwise stated.

If the software does not contain a copy of this license, you can obtain a copy
from https://github.com/ThatOneCalculator/BASED-LICENSE/blob/main/LICENSE or open an issue in the
software's issue tracker, if available. 

The author of this software has the right to claim the software as their own, and while anyone can contribute
to, redistribute, and modify this software, they cannot claim it as their own software,
...
This software may be used for corporate/for-profit purposes as long as it follows every guideline in the Based 
License of the version provided by the contributors. Binaries of this software may be sold.
